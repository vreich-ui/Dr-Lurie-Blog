...
import { objectDisplayName, verbToPhrase, idTooltip } from '../../lib/admin/display-name.js';
import type { ObjectRecord, ObjectType, HistoryEntry } from '../../schema/object-record-v1.js';
