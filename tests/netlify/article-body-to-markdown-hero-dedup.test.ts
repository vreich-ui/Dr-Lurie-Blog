...
// Regression: a hero/featured node with id === 'n_hero' and rendering.placement === 'inline'
// must NOT produce an ![]() embed in the body markdown, because the page template renders it
// in the hero slot via the image: frontmatter field. Emitting it in both places caused the
// same image to appear twice on the published page.
