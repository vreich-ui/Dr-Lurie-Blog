...
const jsonHeaders = {
    'Access-Control-Allow-Headers': 'authorization, content-type, x-upload-token, x-session-id, x-chunk-index, x-total-chunks, x-filename',
...
const parseIntegerHeader = (headers, name) => {
