/**
 * Baseline default THEME for 'thm_platform_default' (T11.7 create-site scaffold).
 ...
 *   --site sites/platform --seeds sites/platform/seeds/themes-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [{ objectType: 'theme', objectId: 'thm_platform_default', body: themeDefaultBody }];
