/**
 * Baseline taxonomy-registry SKELETON for 'tax_platform' (T11.7
 ...
 *   --site sites/platform --seeds sites/platform/seeds/taxonomy-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [{ objectType: 'taxonomy', objectId: 'tax_platform', body: taxonomyBody }];
