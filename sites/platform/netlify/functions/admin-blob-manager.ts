/**
 * Site shim for 'site_platform': instantiates the core `admin-blob-manager` handler with
 * this site's SiteBinding. The implementation is fleet law in
 * packages/core/server/functions/admin-blob-manager.ts; this file is the per-site wire.
 */
...
export * from '../../../../packages/core/server/functions/admin-blob-manager.js';
