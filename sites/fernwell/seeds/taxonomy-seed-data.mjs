/**
 * Baseline taxonomy-registry SKELETON for 'tax_fernwell' (T11.7
 ...
 *   --site sites/fernwell --seeds sites/fernwell/seeds/taxonomy-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [{ objectType: 'taxonomy', objectId: 'tax_fernwell', body: taxonomyBody }];
