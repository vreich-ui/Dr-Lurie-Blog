/**
 * Baseline default THEME for 'thm_fernwell_default' (T11.7 create-site scaffold).
 ...
 *   --site sites/fernwell --seeds sites/fernwell/seeds/themes-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [{ objectType: 'theme', objectId: 'thm_fernwell_default', body: themeDefaultBody }];
