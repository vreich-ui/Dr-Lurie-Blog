 ...
 * packages/core/server/lib/blob-store.ts; this shim exists so the OFF-LIMITS legacy
 ...
 * '../lib/blob-store.js' with identical wire behavior. New code imports core directly.
 */
import '../../src/config/policy-bindings.js'; // register site providers for the legacy path
export * from '../../packages/core/server/lib/blob-store.js';
