 ...
 * packages/core/server/lib/artifact-trust.ts; this shim exists so the OFF-LIMITS legacy
 ...
 * '../lib/artifact-trust.js' with identical wire behavior. New code imports core directly.
 */
import '../../sites/drlurie/config/policy-bindings.js'; // register site providers for the legacy path
export * from '../../packages/core/server/lib/artifact-trust.js';
