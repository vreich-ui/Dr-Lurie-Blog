 ...
 * packages/core/server/lib/netlify-deploys.ts; this shim exists so
 * verify-article-images.ts — the one function still at the repo root — keeps
 * importing '../lib/netlify-deploys.js' with identical wire behavior, and picks
 * up this site's policy bindings on the way. New code imports core directly.
 *
...
export * from '../../packages/core/server/lib/netlify-deploys.js';
