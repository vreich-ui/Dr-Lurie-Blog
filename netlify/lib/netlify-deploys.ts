 ...
 * packages/core/server/lib/netlify-deploys.ts; this shim exists so the OFF-LIMITS legacy
 ...
 * '../lib/netlify-deploys.js' with identical wire behavior. New code imports core directly.
 */
