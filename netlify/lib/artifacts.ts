 ...
 * packages/core/server/lib/artifacts.ts; this shim exists so the OFF-LIMITS legacy
 ...
 * '../lib/artifacts.js' with identical wire behavior. New code imports core directly.
 */
import '../../src/config/policy-bindings.js'; // register site providers for the legacy path
export * from '../../packages/core/server/lib/artifacts.js';
